...
def test_notifications():
    ...
    if not sns_topic_arn:
        ...
        print(
            "aws cloudformation describe-stacks --stack-name bitcoin-auto-trader-dev --query 'Stacks[0].Outputs[?OutputKey==`SNSTopicArn`].OutputValue' --output text"
        )
        return
    ...
    try:
        ...
        notifier.notify_error(
            "테스트 오류",
            "이것은 테스트용 오류 메시지입니다.",
            {"error_code": "TEST_001", "timestamp": "2024-01-01 12:00:00"},
        )
        print("✅ 오류 알림 발송 완료\n")
